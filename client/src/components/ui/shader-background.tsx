...
function loadShader(gl: GL, type: number, source: string): WebGLShader | null {
...
function initShaderProgram(gl: GL, vertexSrc: string, fragmentSrc: string): WebGLProgram | null {
